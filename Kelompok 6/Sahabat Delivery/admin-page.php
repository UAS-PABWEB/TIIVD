  ...
  <div id="main">
    ...
    <div class="wrapper">
      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Menu Makanan</h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">Tambah, Edit Atau Hapus Menu Makanan</p>
              ...
              <div>
				...
				while($row = mysqli_fetch_array($result))
				{
					...
					echo '<select name="'.$row['id'].'_hide">
                      <option value="1"'.$text1.'>Tersedia</option>
                      <option value="2"'.$text2.'>Tidak Tersedia</option>
                    </select></td></tr>';
				}
				?>
                    </tbody>
		  ...
		  <form class="formValidate" id="formValidate1" method="post" action="routers/add-item.php" novalidate="novalidate">
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Tambah Menu Makanan</h4>
              </div>
              <div>
<table>
                    <thead>
				...
				<?php
					...
					echo '<td><div class="input-field col s12 "><label for="price" class="">Harga</label>';

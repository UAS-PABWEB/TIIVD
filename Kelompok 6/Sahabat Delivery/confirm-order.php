          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Detail Pemesanan</h5>
              </div>
            </div>
          </div>
        </div>
...
<?php
    echo '<li class="collection-item avatar">
		...
		<p><strong>Nomor HP:</strong> '.$contact.'</p>
		<p><strong>Alamat:</strong> '.htmlspecialchars($_POST['address']).'</p>	
		<p><strong>Metode Pembayaran:</strong> '.$_POST['payment_type'].'</p>			
...
<button class="btn cyan waves-effect waves-light right" type="submit" name="action" <?php if($_POST['payment_type'] == 'Wallet') {if ($balance-$total < 0) {echo 'disabled'; }}?>>konfirmasi Pesanan

  ...
  <div id="main">
    ...
    <div class="wrapper">
      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Lenkapi Detail Pesanan</h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <!--start container-->
				<div class="container">
          <p class="caption">Lengkapi alamat dan Metode Pembayaran.</p>
          <div class="divider"></div>
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Detail</h4>
              </div>
<div>
                    ...
                    <form class="formValidate col s12 m12 l6" id="formValidate" method="post" action="confirm-order.php" novalidate="novalidate">
                      <div class="row">
                        <div class="input-field col s12">
							<label for="payment_type">Metode Pembayaran</label><br><br>
							<select id="payment_type" name="payment_type">
									<option value="Wallet" selected>Wallet</option>
									<option value="Cash On Delivery" <?php if(!$verified) echo 'disabled';?>>Bayar Di Tempat</option>							
							</select>
                        </div>
                      </div>					
                      <div class="row">
                      ...
                      <div class="row">
                        <div class="input-field col s12">
                          <i class="mdi-action-credit-card prefix"></i>
							...
							<label for="cc_number" class="">Nomor Kartu</label>
                      ...
                      <div class="row">
                        <div class="input-field col s12">
                          <i class="mdi-communication-vpn-key prefix"></i>	
							...
							<label for="cvv_number" class="">Nomor CVV</label>								
        ...
        <div class="container">
          <p class="caption">Estimasi Resi</p>
          <div class="divider"></div>
          <!--editableTable-->
...
?>
  ...
  <!-- END MAIN -->
    ...
    $("#formValidate").validate({
        ...
        messages: {
           address:{
                required: "Masukan Alamat Dengan Jelas",
                minlength: "Masukan Alamat Lebih dari 10 Karakter"
            },	
           cc_number:{
                required: "Mohon Cantumkan Nomor Kartu",
                minlength: "Masukan 16 nomor",
            },	
           cvv_number:{
                required: "Please provide CVV number",
                minlength: "Masukan 3 digit",		
            },				
		},
        errorElement : 'div',

  ...
  <div id="main">
    ...
    <div class="wrapper">
                    ...
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i> Pesanan</a>
                            <div class="collapsible-body">
                                <ul>
								<li><a href="all-orders.php">Semua Pesanan</a>
                                </li>
								<?php
      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Daftar Pengguna</h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">Aktifkan, Nonaktifkan Atau Verifikasi Pengguna.</p>
		  ...
		  <form class="formValidate" id="formValidate1" method="post" action="routers/user-router.php" novalidate="novalidate">
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Daftar Pengguna</h4>
              </div>
              <div>
<table>
                    <thead>
                      <tr>
                        ...
                        <th data-field="price">Klasifikasi</th>
                        <th data-field="price">Verifikasi</th>
                        <th data-field="price">Aktifkan</th>
				...
				while($row = mysqli_fetch_array($result))
				{
					...
					echo '<td><select name="'.$row['id'].'_verified">
                      <option value="1"'.($row['verified'] ? 'selected' : '').'>Terverifikasi</option>
                      <option value="0"'.(!$row['verified'] ? 'selected' : '').'>Tidak Terverifikasi</option>
                    </select></td>';	
					echo '<td><select name="'.$row['id'].'_deleted">
                      <option value="1"'.($row['deleted'] ? 'selected' : '').'>Tidak Aktif</option>
                      <option value="0"'.(!$row['deleted'] ? 'selected' : '').'>Aktif</option>
                    </select></td>';
					$key = $row['id'];
					...
					echo '<td><label for="balance">Jumlah</label><input id="balance" name="'.$row['id'].'_balance" value="'.$balance.'" type="varchar" data-error=".errorTxt01"><div class="errorTxt01"></div></td></tr>'; 					
				}
				?>
                    </tbody>
</table>
			  ...
			  <div class="input-field col s12">
                              <button class="btn cyan waves-effect waves-light right" type="submit" name="action">Modifikasi
		  ...
		  <form class="formValidate" id="formValidate" method="post" action="routers/add-users.php" novalidate="novalidate">
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Tambah Pengguna</h4>
              </div>
              <div>
<table>
                    <thead>
				...
				<?php
					...
					echo '<td><select name="verified">
                      ...
                      <option value="0" selected>Tidak Terverifikasi</option>
                    </select></td>';	
					echo '<td><select name="deleted">
                      <option value="1">NonAktifkan</option>
                      <option value="0" selected>Aktifkan</option>
                    </select></td></tr>';					
				?>
                    </tbody>
</table>
			  ...
			  <div class="input-field col s12">
                              <button class="btn cyan waves-effect waves-light right" type="submit" name="action">Tambah
                                <i class="mdi-content-send right"></i>
                              </button>
                            </div>
            </div>

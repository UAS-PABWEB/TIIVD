<?php 
	...
	$gambar = query("SELECT * FROM users INNER JOIN postingan ON users.id = postingan.id_user WHERE id = '$id'");
		...
		<!-- <?php foreach ($data as $dat): ?> -->
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-2 col-md-2 col-sm-12 imageP">
						<img src="user/Foto Profile/<?= $ambil['image']; ?>" class="img-profile rounded-circle">
					</div>
					<div class="col-lg-7 col-md-10 col-sm-12 deskripsiP">
						<div class="row namaL">
							<h1><?= $ambil['nama_lengkap']; ?></h1>
						</div>
						<div class="row">
							<span class="text-black-600 small">@<?= $ambil['username']; ?></span>
						</div>
						<br>
						<div class="row"></div>

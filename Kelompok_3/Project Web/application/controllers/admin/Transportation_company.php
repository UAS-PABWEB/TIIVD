<?php
class Transportation_company extends CI_Controller{
    ...
    public $table='transportation_company'; 
    public $page='transportation_company'; 
    public $primary_key='id_transportation_company'; 
	public function index($action='',$id=''){
		$data['title'] = 'Perusahaan Transportasi';
		$data['content'] = 'admin/crud_basic';
		$data['tableTitle'] = array('Nama Perusahaan','Logo Perusahaan','Tipe Transportasi');
		$data['tableField'] = array('company_name','company_logo','transportation_type_name');
		$data['inputType'] = array(
								array('type'=>'text','label'=>'Nama Perusahaan','name'=>'company_name'),
								array('type'=>'text','label'=>'Logo Perusahaan','name'=>'company_logo'),
		...
		$data['data'] = $this->m_admin->gTransportationCo();
		if($action=='edit'&&$id!==''){
           $no=0;
	...
	public function p($action,$id=''){
		if($action=='insert'){
			$required = array('company_name','id_transportation_type','company_logo');

        ...
        <div class="content mt-3">  <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                          <a href="?p=tambah_simpanan_ambil" class="btn btn-danger"><i class="fa fa-plus"></i> Ambil Simpanan</a>
                          <hr>
                          <?php 
...
<table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="?p=ubah_simpanan_ambil&id=<?php echo $r['id_simpanan'] ?>" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i> Ubah</a></td>
                      </tr>
                      <?php $no++; } ?>
                    </tbody>
                  </table>

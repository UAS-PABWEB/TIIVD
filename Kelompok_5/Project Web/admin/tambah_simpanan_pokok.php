...
if(!empty($_POST)){
  ...
  $insert_simpanan = mysqli_query($conn,"INSERT INTO simpanan VALUES(NULL,'$id_anggota','$jml_simpan','$tgl_simpan','$jenis_simpan','$jumlah','$jml_total')");
            echo '<meta http-equiv="refresh" content="0; url=index.php?p=kelola_simpanan_pokok&sukses=1">';
}
?>
        <form method="post" enctype="multipart/form-data" class="form-horizontal"> 
          ...
          <div class="row form-group">
            ...
            <div class="col-12 col-md-9">
              <input id="jumlah" type="number" name="jumlah" placeholder="Masukkan Jumlah Pokok" class="form-control" readonly>
            </div>
          </div>
          ...
          <div class="row form-group">
            ...
            <div class="col-12 col-md-9">
              <input id="jml_total" type="number" id="nama" name="jml_total" placeholder="Masukkan Total Pokok" class="form-control" readonly="">
            </div>
          </div>

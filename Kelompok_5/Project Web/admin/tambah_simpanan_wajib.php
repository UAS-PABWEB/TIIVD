  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <strong class="card-title">Tambah Simpanan wajib</strong>
      </div>
      <div class="card-body">
<?php 
if(!empty($_POST)){
  ...
  $insert_simpanan = mysqli_query($conn,"INSERT INTO simpanan VALUES(NULL,'$id_anggota','$jml_simpan','$tgl_simpan','$jenis_simpan','$jumlah','$jml_total')");
            echo '<meta http-equiv="refresh" content="0; url=index.php?p=kelola_simpanan_wajib&sukses=1">';
}
?>
        <form method="post" enctype="multipart/form-data" class="form-horizontal"> 
          ...
          <div class="row form-group">
            ...
            <div class="col-12 col-md-9">
              <input id="jumlah" type="number" name="jumlah" placeholder="Masukkan Jumlah wajib" class="form-control" readonly>
            </div>
          </div>
          ...
          <div class="row form-group">
            ...
            <div class="col-12 col-md-9">
              <input id="jml_total" type="number" id="nama" name="jml_total" placeholder="Masukkan Total wajib" class="form-control" readonly="">
            </div>
          </div>

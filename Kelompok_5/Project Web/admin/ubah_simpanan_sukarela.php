  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <strong class="card-title">Ubah Simpanan Manasuka</strong>
      </div>
      <div class="card-body">
<?php 
if(!empty($_POST)){
  ...
  $insert_simpanan = mysqli_query($conn,"UPDATE simpanan SET id_anggota='$id_anggota',jml_simpan='$jml_simpan',jumlah='$jumlah',tgl_simpan='$tgl_simpan',jenis_simpan='$jenis_simpan',jumlah='$jumlah',jml_total='$jml_total'WHERE id_simpanan='$id_simpanan' ");
            echo '<meta http-equiv="refresh" content="0; url=index.php?p=kelola_simpanan_sukarela&sukses=2">';
}
?>
        <form method="post" enctype="multipart/form-data" class="form-horizontal"> 
          ...
          <div class="row form-group">
            ...
            <div class="col-12 col-md-9">
              <input id="jumlah" type="number" value="<?php echo $data['jumlah'] ?>" name="jumlah" placeholder="Masukkan Jumlah Manasuka" class="form-control" readonly>
            </div>
          </div>
          ...
          <div class="row form-group">
            ...
            <div class="col-12 col-md-9">
              <input id="jml_total" type="number" id="nama" name="jml_total" value="<?php echo $data['jml_total'] ?>" placeholder="Masukkan Total Manasuka" class="form-control" readonly="">
            </div>
          </div>

...
<table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    <tbody>
                      <?php
                       $query  = mysqli_query($conn,"SELECT * FROM simpanan INNER JOIN anggota ON anggota.id_anggota  = simpanan.id_anggota WHERE jenis_simpan='ambil' AND simpanan.id_anggota='$id_anggota'");
                       $no=1;

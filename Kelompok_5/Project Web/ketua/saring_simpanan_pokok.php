...
<table id="table-export" class="table table-striped table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a onclick="return confirm('Apakah anda yakin?')" href="?p=hapus_simpanan_pokok&id=<?php echo $r['id_simpanan'] ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Hapus</a></td>
                      </tr>
                      <?php $no++; } ?>
                    </tbody>
                  </table>
